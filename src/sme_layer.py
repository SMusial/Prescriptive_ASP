...
SME_OBSERVATIONS = [
    ...
    },
    {
        ...
        "profile": "mountain",
        "asp": "AlpineReach",
        "business_observation": "AlpineReach is assigned difficult emergency jobs because they know the region best. This is not visible in task complexity data alone.",
    ...
    },
    {
        ...
        "profile": "mountain",
        "asp": "AlpinGmbH",
        "business_observation": "A major infrastructure event is planned in AlpinGmbH regions for the next 2 weeks — road closures and site access will significantly delay deliveries.",
        "confidence_level": "High",
        "valid_from": "2026-05-01",
