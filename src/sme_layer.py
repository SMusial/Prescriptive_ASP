...
SME_OBSERVATIONS = [
    ...
    },
    {
        ...
        "profile": "mountain",
        "asp": "AlpinGmbH",
        "business_observation": "Flood risk alert for 2 districts in the upcoming planning period — AlpinGmbH has the highest task concentration in those areas, expect significant delivery delays.",
        "confidence_level": "High",
        "valid_from": "2026-05-01",
